...
WHERE 
    ...
    AND TO_DATE(FROM_UNIXTIME(CAST(tpep_dropoff_datetime / 1000000 AS BIGINT))) = '2022-01-01'""".format(
...
def calculate_overlap(records):
    ...
    records = [
        {
            "start_time": datetime.utcfromtimestamp(int(record[0]) // 1000000),
            "end_time": datetime.utcfromtimestamp(int(record[1]) / 1000000),
        }
